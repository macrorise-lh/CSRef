"""
HuggingFace version of RefCOCOg Speech dataset configuration.

Run:
# [Train]
# CUDA_VISIBLE_DEVICES=0 PORT=23453 bash tools/train_speech.sh configs/csref_refcocog_speech_hf.py 1
# [Eval]
CUDA_VISIBLE_DEVICES=0 PORT=23453 bash tools/eval_speech.sh configs/csref_refcocog_speech_hf.py 1 data/weights/csref_refcocog_speech.pth
"""
...
train.output_dir = "./output/csref_refcocog_speech_hf"  # Updated output directory
