...
Run:
# [Train]
# CUDA_VISIBLE_DEVICES=0 PORT=23456 bash tools/train_speech.sh configs/csref_sreffaceg.py 1
# [Eval]
CUDA_VISIBLE_DEVICES=0 PORT=23456 bash tools/eval_speech.sh configs/csref_sreffaceg.py 1 data/weights/csref_sreffaceg.pth
"""
...
# dataset config
dataset.dataset = "sreffaceg"
dataset.ann_path["sreffaceg"] = "./data/anns/face_centric/sreffaceg.json"
dataset.image_path["sreffaceg"] = "./data/images/train2014"
...
train.output_dir = "./output/csref_sreffaceg"  #
