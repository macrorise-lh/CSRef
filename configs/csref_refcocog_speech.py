...
Run:
# [Train]
# CUDA_VISIBLE_DEVICES=0 PORT=23452 bash tools/train_speech.sh configs/csref_refcocog_speech.py 1
# [Eval]
CUDA_VISIBLE_DEVICES=0 PORT=23452 bash tools/eval_speech.sh configs/csref_refcocog_speech.py 1 data/weights/csref_refcocog_speech.pth
"""
...
# dataset config
dataset.dataset = "refcocog_speech"
dataset.ann_path["refcocog_speech"] = "./data/anns/general_object/refcocog_speech.json"
dataset.image_path["refcocog_speech"] = "./data/images/train2014"
dataset.audio_root = "./data/audios/refcocog_speech"
...
train.output_dir = "./output/csref_refcocog_speech"  #
