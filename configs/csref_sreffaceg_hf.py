"""
HuggingFace version of sRefFACEg dataset configuration.

Run:
# [Train]
# CUDA_VISIBLE_DEVICES=0 PORT=23456 bash tools/train_speech.sh configs/csref_sreffaceg_hf.py 1
# [Eval]
CUDA_VISIBLE_DEVICES=0 PORT=23456 bash tools/eval_speech.sh configs/csref_sreffaceg_hf.py 1 data/weights/csref_sreffaceg.pth
"""
...
train.output_dir = "./output/csref_sreffaceg_hf"  # Updated output directory
