...
Run:
# [Train]
# CUDA_VISIBLE_DEVICES=0 PORT=23454 bash tools/train_speech.sh configs/csref_srefface_hf.py 1
# [Eval]
CUDA_VISIBLE_DEVICES=0 PORT=23454 bash tools/eval_speech.sh configs/csref_srefface_hf.py 1 data/weights/csref_srefface.pth
"""
...
train.output_dir = "./output/csref_srefface_hf"  # Updated output directory
