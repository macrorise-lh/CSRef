...
Run:
# [Train]
# CUDA_VISIBLE_DEVICES=0 PORT=23454 bash tools/train_speech.sh configs/csref_srefface.py 1
# [Eval]
CUDA_VISIBLE_DEVICES=0 PORT=23454 bash tools/eval_speech.sh configs/csref_srefface.py 1 data/weights/csref_srefface.pth
"""
...
dataset.audio_root = "./data/audios/refcoco_speech"
