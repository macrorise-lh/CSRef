"""
HuggingFace version of sRefFACE+ dataset configuration.

Run:
# [Train]
# CUDA_VISIBLE_DEVICES=0 PORT=23455 bash tools/train_speech.sh configs/csref_srefface+_hf.py 1
# [Eval]
CUDA_VISIBLE_DEVICES=0 PORT=23455 bash tools/eval_speech.sh configs/csref_srefface+_hf.py 1 data/weights/csref_srefface+.pth
"""
...
train.output_dir = "./output/csref_srefface+_hf"  # Updated output directory
