...
Run:
# [Train]
# CUDA_VISIBLE_DEVICES=0 PORT=23452 bash tools/train_speech.sh configs/csref_refcoco+_speech.py 1
# [Eval]
CUDA_VISIBLE_DEVICES=0 PORT=23452 bash tools/eval_speech.sh configs/csref_refcoco+_speech.py 1 data/weights/csref_refcoco+_speech.pth
"""
...
dataset.audio_root = "./data/audios/refcoco+_speech"
